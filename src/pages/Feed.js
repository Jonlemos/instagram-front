                ...
                {this.state.feed.map(post => (
                    <article key={post._id}>
                        <header>
                            ...
                            <img src={more} className="more" alt="Mais"/>
                        </header>
                        <img src={`http://localhost:3333/files/${post.image}`} alt=""></img>
                        <footer>
                            <div className="actions">
                                <button type="button" onClick={() => this.handlerLike(post._id)}>
                                    <img src={like} className="more" alt="like"/>
                                </button>
                                <img src={comment} className="more" alt="comment"/>
                                <img src={send} className="more" alt="send"/>
